...
/***/ function(module, exports, __webpack_require__) {
	...
	var Results = __webpack_require__(164);
			...
			if (prevState.searchTerm != this.state.searchTerm) {
				...
				helpers.runQuery(this.state.searchTerm).then(function (data) {
					if (data != this.state.results) {
						console.log("HERE");
						console.log(data);
						//sends data down to child
						this.setState({
							results: data
						});
					}
					helpers.storeSearch(this.state.searchTerm);
					helpers.displaySearches();
	...
	var helpers = {
		...
		runQuery: function runQuery(location) {
			...
			return axios.get(queryURL).then(function (response) {
				...
				console.log("Run query .get response: " + response);
				return response.data.results[0].formatted;
			});
		},

		storeSearch: function storeSearch(search) {

			console.log("This is your search: " + search);

			return axios.post('/api', { "search": search }).then(function (response) {
				console.log("Store search .post response: " + response.body);
			});
		},

		displaySearches: function displaySearches(results) {

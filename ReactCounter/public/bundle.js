					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(Child, { counter: this.state.counter })
							)
						)
					)
				)
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'h4',
						null,
						this.state.number + 2 * this.props.counter
					),
					React.createElement(GrandChild, { number: this.state.number + 2 * this.props.counter })
				)
			);
		}
	});
